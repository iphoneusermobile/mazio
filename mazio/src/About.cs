...
namespace mazio
{
    sealed partial class About : Form
    {
        public About()
        {
            InitializeComponent();
...
//            textBoxDescription.Text = AssemblyDescription;
        ...
        {
            try {
                Process.Start("http://www.kalamonsoft.com/");
            } catch (Exception) {
        ...
        {
            try {
                Process.Start("http://www.kalamonsoft.com/mazio");
            } catch (Exception) {

            }
        }

        private void aboutKeyDown(object sender, KeyEventArgs e) {
