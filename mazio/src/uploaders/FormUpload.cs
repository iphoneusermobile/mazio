...
{
    //
    // from http://www.briangrinstead.com/blog/multipart-form-post-in-c
    //
    ...
    public static class FormUpload
    {
        ...
        public static HttpWebResponse MultipartFormDataPost(string postUrl, string userAgent, Dictionary<string, object> postParameters) {
            return MultipartFormDataPost(postUrl, userAgent, postParameters, null);
        }

        public static HttpWebResponse MultipartFormDataPost(string postUrl, string userAgent, 
            Dictionary<string, object> postParameters, Cookie cookie) {
            ...
            return PostForm(postUrl, userAgent, contentType, formData, cookie);
        }

        private static HttpWebResponse PostForm(string postUrl, string userAgent, string contentType, byte[] formData, Cookie cookie)
        {
